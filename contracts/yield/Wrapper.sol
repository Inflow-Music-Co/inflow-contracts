...
} from "./VaultLifecycleWithSwap.sol";
    ...
    ERC20Upgradeable
{
     ...
     * @param _token1 is the first token contract
     * @param _token2 is the second token contract
     * @param _vault is the yearn vault contract
     */
    constructor(
        address _token1,
        address _token2,
