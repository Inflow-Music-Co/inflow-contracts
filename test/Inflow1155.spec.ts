...
// describe("Inflow1155 Tests", async function (){
...
//     try {
//       const tokenId = await create(inflowCreator, data);
//       await expect(inflow.connect(signers[2]).callStatic.mint(tokenId, 1)).to.be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
//   });
...
//       await expect(inflowCreator.callStatic.mint(tokenId, supplyDiff.add(10))).to.be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
//   });
...
//     try {
//       const tokenId = await create(inflowCreator, data);
//       await expect(inflowCreator.callStatic.mintBatch([tokenId], [1, 1])).to.be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
//   });
...
//     try {
//       const tokenId = await create(inflowCreator, data);
//       expect(inflow.connect(signers[3]).callStatic.mintBatch([tokenId], [1])).to.be
//      .reverted;
//     } catch (err) {
//       console.error(err);
//     }
...
//       const { supply, maxSupply } = await inflow.getToken(tokenId);
//       const supplyDiff = maxSupply.sub(supply);
//       expect(inflowCreator.callStatic.mintBatch([tokenId], [supplyDiff.add(10)])).to
//         .be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
...
//       expect(inflowCreator.callStatic.mint(tokenId, 90)).to.be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
//   });
...
//     try {
//       expect(inflow.callStatic.burn(300, 1)).to.be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
//   });
...
//     try {
//       await expect(inflow.callStatic.uri(300)).to.be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
//   });
...
//     try {
//       await expect(inflow.callStatic.getToken(0)).to.be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
//   });
...
//     try {
//       await expect(inflow.callStatic.updateRoyaltyAccount(1, accounts[7], accounts[0])).to
//         .be.reverted;
//     } catch (err) {
//       console.error(err);
//     }
...
//     try {
//       expect(inflow.callStatic.create({
//           supply: 10,
//           maxSupply: 100,
//           uri: URI,
